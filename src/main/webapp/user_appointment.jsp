	...
	<div class="container p-3">
		...
		<div class="row">
			...
			<div class="col-md-6 p-5">
				...
				<img alt="" src="img/pic3.jpg" width="500" height="550">
			</div>
				...
				<div class="card my-card">
					<div class="card-body">
						...
						<form class="row g-3" action="addAppointment" method="post">
							...
							<div class="col-md-6">
								<label class="form-label">Name of Company</label> <input
									required="required" name="company" type="text"
							...
							<div class="col-md-6">
								<label class="form-label">Phone</label> <input name="phone"
									required="required" type="number" maxlength="12"
									placeholder="Enter Mobile no." class="form-control">
							</div>

							<div class="col-md-6">
								<label class="form-label">Enter Consulting type</label> <input
									required="required" name="needToConsult" type="text"
									placeholder="Enter your choice" class="form-control">
							</div>

							<div class="col-md-6">
								<label class="form-label">Consultant</label> <select
									required="required" class="form-control"
									name="employeeNameSelect">
									...
									for (Employee d : listOfEmployee)

									{
									%>
									<!-- actually we take id of employee from employee table -->
							...
							<div class="col-md-12">
								<label class="form-label">Please Elaborate your issue</label>
								<textarea name="issue" required="required"
							...
							<c:if test="${not empty userObj}">
								...
								<div class="col-md-12">
									<button type="submit"
										...
										style="border-radius: 100px; background-color: navy;">Submit</button>
								</div>
