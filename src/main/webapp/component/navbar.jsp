...
<nav class="navbar navbar-expand-lg navbar-dark"
	...
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"><i class="fa-brands fa-wpbeginner"></i>ConsultingArc</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<c:if test="${empty userObj}">
					...
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="consultant_login.jsp"> CONSULTANT
					</a></li>
					<li class="nav-item"><a class="nav-link active"
						aria-current="page" href="user_login.jsp"><i
							class="fas fa-sign-in-alt"></i> USER</a></li>
