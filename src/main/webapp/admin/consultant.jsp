		...
		<div class="row">
			<div class="col-md-5 offset-4">
				<div class="card my-card">
					<div class="card-body">
						<p class="fs-3 text-center text-danger">Consultant Appointment</p>
						...
						<form action="../addEmployee" method="post">
							<div class="mb-3">
								<label class="form-label">Full Name</label> <input
									name="fullName" type="text" pattern="^[a-zA-Z ]*$" required
							...
							<div class="mb-3">
								<label class="form-label">Password</label> <input
								 ...
								 required title="Minimum eight characters, at least one upper placeholder="Enter password"
									class="form-control">
							</div>

							<button type="submit" class="btn btn-danger text-white col-md-12"
								style="border-radius: 80px;">Register</button>
						</form>
