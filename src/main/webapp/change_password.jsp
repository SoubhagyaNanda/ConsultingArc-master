		...
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<div class="card my-card">
					...
					<div class="card-body">
						<p class="fs-3 text-center myP-color" style="color: navy;">Change Password</p>
						...
						<form action="userChangePassword" method="post">
							...
							<button type="submit" class="btn my-bg-color text-white col-md-12" style="background-color:navy; ">Change
								Password</button>
						</form>
					</div>
				</div>
