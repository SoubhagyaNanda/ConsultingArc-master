...
<%@page import="com.consulting_Arc.entity.User"%>
...
<body>
						...
						<table class="table table-striped">
							<thead>
								<tr class="my-bg-color text-white">
									...
									<th scope="col">NeedToConsultOn</th>
							...
							<tbody>
								...
								EmployeeDAO dDAO = new EmployeeDAO(DBConnection.getConn());
								...
								for (Appointment apptList : list) {
									Employee employee = dDAO.getEmployeeById(apptList.getEmployeeId());
								...
								<tr>
									...
									<td><%=apptList.getNeedToConsult()%></td>
 ...
 %>
			...
			<div class="col-md-3 p-3">
				...
				<img alt="" src="img/f7.jpg" width="350" height="400">
			</div>
